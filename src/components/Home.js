    ...
    <main className="screen-main screen-mode">
      <section className="content mode-scorer">
        ...
        <div className="content-box">
          <img
            src={`${process.env.PUBLIC_URL}/images/mode-scorer.svg`}
            alt="Scorer Mode"
          />
          <nav className="content-nav">
            {props.app.scorerSession ? (
              <input
                className="btn btn-3 btn-secondary"
                type="button"
                name="continue-scorer"
                value="Continue"
      ...
      <section className="content mode-solitaire">
        ...
        <div className="content-box">
          <img
            src={`${process.env.PUBLIC_URL}/images/mode-solitaire.svg`}
            alt="Solitaire Mode"
          />
          <nav className="content-nav">
